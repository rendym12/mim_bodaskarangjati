...
<div class="content-wrapper sarana-page">
    ...
    <div class="detail-card">
        <div class="detail-header">
            <i class="fas <?= $row['ikon'] ?? 'fa-building' ?>"></i>
            <h2><?= htmlspecialchars($row['nama_sarana']) ?></h2>
        </div>
        ...
        <div class="detail-body">
            <div class="detail-info-grid">
                <div class="detail-info-card">
                    ...
                    <div class="detail-info-content">
                        ...
                        <span class="info-value"><?= $row['ikon'] ?? 'fa-building' ?></span>
                    </div>
                </div>
                <div class="detail-info-card">
                ...
                <div class="detail-info-card">
                    ...
                    <div class="detail-info-content">
                        ...
                        <span class="info-value">Ada</span>
                    </div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="detail-gambar">
                <img src="../../uploads/sarana/<?= $row['gambar'] ?>" alt="<?= htmlspecialchars($row['nama_sarana']) ?>">
            </div>
            <?php endif; ?>
